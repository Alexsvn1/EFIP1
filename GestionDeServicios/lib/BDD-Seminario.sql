...
INSERT INTO Solicitud (fechaRegistro, estado, descripcion, idCiudadano, idServicio, tipoServicio) VALUES
('2024-10-01', 'pendiente', 'Solicitud de recolección de basura', 1, 1, 'Recolección de Basura'),
('2024-10-02', 'en_proceso', 'Solicitud de poda de árboles', 2, 2, 'Poda de Árboles'),
('2024-10-03', 'completada', 'Solicitud de iluminación pública', 3, 3, 'Iluminación Pública');
